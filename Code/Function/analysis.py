...
class Model:
    ...
    def Get_Model(self):
        if self.input == 'exponential': return ds.DynamicalSystem_Simple(self.group, self.gap_idx)
    ...
    def Draw(self):
        def Draw_Trace_2d():
            ...
            axs[0].plot(np.arange(0, 1.0, 1/len(self.model.times)), self.x, color=colors_unit[0])
            axs[0].plot(np.arange(0, 1.0, 1/len(self.model.times)), self.PCs[0], color=colors_PC[0], alpha = 0.5)
            axs[1].plot(np.arange(0, 1.0, 1/len(self.model.times)), self.y, color=colors_unit[1])
            axs[1].plot(np.arange(0, 1.0, 1/len(self.model.times)), self.PCs[1], color=colors_PC[1], alpha = 0.5)
            axs[2].plot(np.arange(0, 1.0, 1/len(self.model.times)), self.z, color=colors_unit[2])
            axs[2].plot(np.arange(0, 1.0, 1/len(self.model.times)), self.PCs[2], color=colors_PC[2], alpha = 0.5)
            axs[3].plot(np.arange(0, 1.0, 1/len(self.model.times)), self.Input_On, color='darkgreen')
            axs[3].plot(np.arange(0, 1.0, 1/len(self.model.times)), self.Input_Off, color='limegreen')
        ...
        def Draw_Gap_Duration_Recognition():
            ...
            for i in range(10):
                ...
                baseline = np.mean(calculate_distance(self.PCs, start = 50, end = 100))
        ...
        self.Input_On, self.Input_Off = self.model.OnS, self.model.OffS
